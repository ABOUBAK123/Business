...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    <a href="<?php echo e(route('admin.index', ['tab' => $t])); ?>"
       class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 hover:shadow-md transition group">
        <div class="h-11 w-11 rounded-xl bg-<?php echo e($color); ?>-100 flex items-center justify-center mb-3">
        ...
        <div id="tpl-list-container" class="space-y-2">
            ...
            <div class="border rounded-lg p-3 <?php echo e($selectedTplId === $tpl->id ? 'border-blue-500 bg-blue-50' : 'border-gray-200 bg-gray-50'); ?>">
                ...
                <div class="mt-2 flex flex-wrap gap-1.5">
                    ...
                    <?php if($tpl->storage_path && in_array($tpl->file_type, ['docx','xlsx','pptx'])): ?>
                    ...
                    <?php endif; ?>
                    <?php elseif(!$tpl->storage_path && $tpl->variables->count() === 0 && in_array($tpl->file_type, ['docx','xlsx','pptx'])): ?>
...
<?php endif; ?>
        ...
        <div id="tpl-oo-upload-panel" class="hidden flex-shrink-0 border-b border-purple-200 bg-purple-50 px-5 py-4">
            ...
            <form id="tpl-oo-upload-form" class="grid grid-cols-1 md:grid-cols-3 gap-3 items-end" onsubmit="tplOoSubmitUpload(event)">
                ...
                <?php else: ?>
                <input type="hidden" id="tpl-oo-up-admin" value="<?php echo e(auth()->user()->profile->administration_id ?? ''); ?>">
                <div>
                    <label class="block text-xs font-semibold text-purple-700 mb-1">Administration</label>
...
<div class="grid grid-cols-1 gap-5">
  <section class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
    ...
    <div class="space-y-2 max-h-96 overflow-auto mt-2">
      ...
      <div class="border rounded-lg p-3 <?php echo e($selEmitId === $item->id ? 'border-blue-500 bg-blue-50' : 'border-gray-200 bg-gray-50'); ?>">
      ...
      <div class="rounded-xl border border-gray-200 p-4 space-y-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-[88px_1fr] gap-3 items-center">
          <div class="w-20 h-20 rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 flex items-center justify-center overflow-hidden">
            <?php if($re && $re->logo): ?>
              <img src="<?php echo e(asset($re->logo)); ?>" alt="Logo actuel" class="w-full h-full object-contain" id="recip-logo-preview-img">
            <?php else: ?>
      ...
      <div class="recip-card border border-gray-200 bg-gray-50 rounded-lg p-2.5
        ...
        <div class="flex items-start gap-3">
          <div class="w-8 h-8 rounded-md border border-gray-200 bg-white overflow-hidden flex items-center justify-center shrink-0">
            <?php if($item->logo): ?>
              <img src="<?php echo e(asset($item->logo)); ?>" alt="Logo <?php echo e($item->name); ?>" class="w-full h-full object-contain">
            <?php else: ?>
...
<div class="grid grid-cols-1 xl:grid-cols-[0.95fr_1.05fr] gap-5">
  ...
  <section class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-3">
    <div class="flex items-center justify-between">
      ...
      <span class="text-xs text-gray-400"><?php echo e($directionTypes->count()); ?> type<?php echo e($directionTypes->count() > 1 ? 's' : ''); ?></span>
    </div>
    ...
    <div class="overflow-auto rounded-xl border border-gray-200">
      <table class="w-full min-w-[520px] text-left">
        ...
        <tbody class="divide-y divide-gray-100 text-xs bg-white">
          ...
          <tr class="<?php echo e($editDt && $editDt->id === $dt->id ? 'bg-blue-50' : ''); ?>">
        ...
        <tr class="hover:bg-gray-50 transition">
          ...
          <td class="px-4 py-3">
            <div class="flex items-center gap-1">
              ...
              <button type="button"
                onclick="openUserEditModal(<?php echo e(json_encode(['id'=>$u->id,'nom'=>$nom,'prenoms'=>$prenoms,'name'=>$u->name,'email'=>$u->email,'role'=>$u->role,'profile_id'=>$u->profile_id ?? '','status'=>$u->status,'quota'=>$u->quota ?? '','scope_type'=>$dir?->direction_scope_type ?? '','scope_id'=>$dir?->direction_scope_id ?? '','sub_code'=>$dir?->sub_entity_code ?? ''])); ?>)"
...
<div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
    ...
    <form method="POST" action="<?php echo e(route('admin.settings.save')); ?>" class="p-6 space-y-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$key, $label, $placeholder, $type]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1.5"><?php echo e($label); ?></label>
                <input type="<?php echo e($type); ?>" name="<?php echo e($key); ?>" value="<?php echo e(old($key, $settings[$key]->value ?? '')); ?>"
        ...
        <div>
            ...
            <select name="mail_encryption" class="border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-red-400">
                <?php $__currentLoopData = ['tls'=>'TLS', 'ssl'=>'SSL', ''=>'Aucune']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($val); ?>" <?php echo e(($settings['mail_encryption']->value ?? 'tls') === $val ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div class="pt-2">
    ...
    <table class="w-full min-w-[600px] text-sm">
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-4 py-3 text-gray-500 truncate max-w-[150px] hidden md:table-cell"><?php echo e($profile->administration?->name ?? '—'); ?></td>
                ...
                <td class="px-4 py-3 text-right whitespace-nowrap">
                    <div class="inline-flex items-center gap-2">
                        <button type="button"
                           onclick="openProfileEditModal(<?php echo e(json_encode(['id'=>$profile->id,'name'=>$profile->name,'description'=>$profile->description ?? '','perms'=>is_array($profile->permissions) ? ($profile->permissions['menuPermissions'] ?? $profile->permissions) : []])); ?>)"
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition <?php echo e(request('edit_instr') == $instr->id ? 'bg-cyan-50' : ''); ?>">
